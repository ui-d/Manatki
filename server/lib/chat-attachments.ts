  ...
  const attachmentContext = [
    ...
    uploaded.length > 0
      ? [
          ...
          "- Figma `.fig` files are not importable. Ask the user to export brand pages as images or paste token values, then build the design system from those sources (see the design-systems skill).",
