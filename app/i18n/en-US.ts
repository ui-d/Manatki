...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "Saved as template",
  ...
  home: {
    ...
    useTemplateWithBrief: "Use with a brief…",
    templateEmptyState: "No templates yet. Open a project and pick \"Save as template\" to create one.",
    useTemplateFailed: "Could not create a project from this template",
    useTemplateAgentLabel: "Use template \"{{title}}\"",
    templateBriefTitle: "Use \"{{title}}\" with a brief",
    templateBriefPlaceholder: "What is the new project about? Audience, product, key message…",
    templateBriefSubmit: "Create & rebrand",
