...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "टेम्पलेट के रूप में सहेजा गया",
  ...
  home: {
    ...
    socialBadge: "सोशल",
    filterTemplates: "टेम्पलेट",
    templateBadge: "टेम्पलेट",
    useTemplate: "टेम्पलेट उपयोग करें",
    useTemplateWithBrief: "ब्रीफ़ के साथ उपयोग करें…",
    templateEmptyState: "अभी कोई टेम्पलेट नहीं है। कोई प्रोजेक्ट खोलें और \"टेम्पलेट के रूप में सहेजें\" चुनें।",
    useTemplateFailed: "इस टेम्पलेट से प्रोजेक्ट नहीं बनाया जा सका",
    useTemplateAgentLabel: "\"{{title}}\" टेम्पलेट उपयोग करें",
    templateBriefTitle: "ब्रीफ़ के साथ \"{{title}}\" उपयोग करें",
    templateBriefPlaceholder: "नया प्रोजेक्ट किस बारे में है? दर्शक, उत्पाद, मुख्य संदेश…",
    templateBriefSubmit: "बनाएँ और रीब्रांड करें",
    assetCount_one: "एसेट",
