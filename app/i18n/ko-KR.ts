...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "템플릿으로 저장했습니다",
  ...
  home: {
    ...
    templateBadge: "템플릿",
    useTemplate: "템플릿 사용",
    useTemplateWithBrief: "브리프와 함께 사용…",
    templateEmptyState: "아직 템플릿이 없습니다. 프로젝트를 열고 \"템플릿으로 저장\"을 선택해 만들어 보세요.",
    useTemplateFailed: "이 템플릿으로 프로젝트를 만들지 못했습니다",
    useTemplateAgentLabel: "\"{{title}}\" 템플릿 사용",
    templateBriefTitle: "브리프와 함께 \"{{title}}\" 사용",
    templateBriefPlaceholder: "새 프로젝트는 무엇에 관한 것인가요? 대상, 제품, 핵심 메시지…",
    templateBriefSubmit: "만들고 리브랜딩",
    assetCount_other: "에셋",
