...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "Enregistré comme modèle",
  ...
  home: {
    ...
    socialBadge: "Social",
    filterTemplates: "Modèles",
    templateBadge: "Modèle",
    useTemplate: "Utiliser le modèle",
    useTemplateWithBrief: "Utiliser avec un brief…",
    templateEmptyState: "Aucun modèle pour l'instant. Ouvrez un projet et choisissez « Enregistrer comme modèle » pour en créer un.",
    useTemplateFailed: "Impossible de créer un projet à partir de ce modèle",
    useTemplateAgentLabel: "Utiliser le modèle « {{title}} »",
    templateBriefTitle: "Utiliser « {{title}} » avec un brief",
    templateBriefPlaceholder: "De quoi parle le nouveau projet ? Audience, produit, message clé…",
    templateBriefSubmit: "Créer et adapter",
