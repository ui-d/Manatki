...
const messages = {
  ...
  raw: {
    ...
    saveFailed: "儲存失敗",
    saveFailedRetrying: "儲存失敗 — 正在重試。您最近的編輯尚未儲存。",
    offline: "離線",
    selected: "已選取",
  ...
  editorToolbar: {
    ...
    slideSize: "畫布尺寸",
    setSlideSize: "將此素材設為 {{label}}（{{width}}×{{height}}）",
    sizeCategoryPosts: "貼文",
    sizeCategoryVertical: "限時動態與直式",
    sizeCategoryBanners: "橫幅與封面",
    sizeCategoryWeb: "網頁與影片",
    sizeCategoryAds: "多媒體廣告",
    sizePreset: {
      "ig-square": "Instagram 方形（1:1）",
      "ig-portrait": "Instagram 直式（4:5）",
      "fb-post": "Facebook 貼文（1.91:1）",
      "x-post": "X / Twitter 貼文（16:9）",
      "ig-story": "限時動態 / Reels / TikTok（9:16）",
      "pinterest-pin": "Pinterest 釘圖（2:3）",
      "linkedin-banner": "LinkedIn 橫幅",
      "x-header": "X / Twitter 標頭圖",
      "fb-cover": "Facebook 封面",
      "email-header": "電子郵件標頭",
      "og-banner": "連結預覽 / OG 圖片",
      "yt-thumbnail": "YouTube 縮圖（16:9）",
      "ad-mrec": "廣告 — 中矩形（300×250）",
      "ad-half-page": "廣告 — 半版（300×600）",
      "ad-leaderboard": "廣告 — 頁首橫幅（728×90）",
    },
    customSize: "自訂尺寸",
    applyCustomSize: "套用",
    customSizeInvalid: "請輸入 {{min}} 到 {{max}} 像素之間的寬度和高度",
    slideTools: "幻燈片工具",
    ...
    savedAsTemplateToast: "已另存為範本",
    saveAsTemplateFailed: "無法另存為範本",
    savedVersions: "已儲存版本",
    lightTheme: "淺色主題",
    darkTheme: "深色主題",
  },
  ...
  home: {
    ...
    projectTypeDeck: "簡報",
    projectTypeSocial: "社群素材",
    newProject: "新增",
    newProjectDeckHint: "用於簡報的幻燈片",
    newProjectSocialHint: "貼文、限時動態、橫幅",
    newDeckCardTitle: "新增簡報",
    newSocialCardTitle: "新增社群素材",
    newDeckPromptTitleSocial: "新增社群素材",
    newDeckPlaceholderSocial: "描述你需要的貼文、限時動態或橫幅...",
    showAllKinds: "顯示所有專案",
    showDecksOnly: "僅顯示簡報",
    showSocialOnly: "僅顯示社群素材",
    kindFilterDecks: "幻燈片",
    kindFilterSocial: "社群",
    socialBadge: "社群",
    filterTemplates: "範本",
    templateBadge: "範本",
    useTemplate: "使用範本",
    useTemplateWithBrief: "附簡報使用…",
    templateEmptyState: "還沒有範本。開啟一個專案並選擇「另存為範本」即可建立。",
    useTemplateFailed: "無法根據此範本建立專案",
    useTemplateAgentLabel: "使用範本「{{title}}」",
    templateBriefTitle: "附簡報使用「{{title}}」",
    templateBriefPlaceholder: "新專案是關於什麼？受眾、產品、核心訊息…",
    templateBriefSubmit: "建立並改寫",
    assetCount_other: "個素材",
    slideCount_other: "張幻燈片",
    noKindMatches: "還沒有此類型的專案。",
    socialFormatsQuestion: "你需要哪些格式？",
    socialFormatsHeader: "格式",
    socialFormatsSquare: "方形貼文",
    socialFormatsCampaign: "行銷活動組合（貼文 + 限時動態 + 橫幅）",
    socialFormatsStory: "限時動態 / Reels",
