...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "テンプレートとして保存しました",
  ...
  home: {
    ...
    socialBadge: "SNS",
    filterTemplates: "テンプレート",
    templateBadge: "テンプレート",
    useTemplate: "テンプレートを使用",
    useTemplateWithBrief: "ブリーフ付きで使用…",
    templateEmptyState: "テンプレートはまだありません。プロジェクトを開いて「テンプレートとして保存」を選ぶと作成できます。",
    useTemplateFailed: "このテンプレートからプロジェクトを作成できませんでした",
    useTemplateAgentLabel: "テンプレート「{{title}}」を使用",
    templateBriefTitle: "「{{title}}」をブリーフ付きで使用",
    templateBriefPlaceholder: "新しいプロジェクトの内容は？ 対象、製品、キーメッセージ…",
    templateBriefSubmit: "作成してリブランド",
