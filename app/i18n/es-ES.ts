...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "Guardado como plantilla",
  ...
  deckEditor: {
    ...
    exportImageWarning: "Algunas imágenes pueden salir en blanco",
    exportImageWarningDetail:
      "{{total}} imagen(es) enlazada(s) bloquearon la carga entre orígenes (CORS) y se exportaron en blanco. Vuelve a subirlas a la biblioteca de recursos o alójalas con CORS habilitado.",
  ...
  home: {
    ...
    useTemplateWithBrief: "Usar con un brief…",
    templateEmptyState: "Aún no hay plantillas. Abre un proyecto y elige «Guardar como plantilla» para crear una.",
    useTemplateFailed: "No se pudo crear un proyecto desde esta plantilla",
    useTemplateAgentLabel: "Usar la plantilla «{{title}}»",
    templateBriefTitle: "Usar «{{title}}» con un brief",
    templateBriefPlaceholder: "¿De qué trata el nuevo proyecto? Audiencia, producto, mensaje clave…",
    templateBriefSubmit: "Crear y adaptar",
