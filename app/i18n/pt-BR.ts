...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "Salvo como modelo",
  ...
  brandCheck: {
    title: "Verificação de marca",
    checkedAgainst: "Comparado com {{title}}",
    clean: "Tudo dentro da marca — nenhum problema encontrado.",
    fixWithAi: "Corrigir com IA",
    fixMessage: "Corrigir {{total}} problemas de marca encontrados",
    recheck: "Verificar novamente",
    failed: "Falha na verificação de marca",
    slide: "Slide {{slide}}",
  ...
  home: {
    ...
    socialBadge: "Social",
    filterTemplates: "Modelos",
    templateBadge: "Modelo",
    useTemplate: "Usar modelo",
    useTemplateWithBrief: "Usar com um briefing…",
    templateEmptyState: "Nenhum modelo ainda. Abra um projeto e escolha \"Salvar como modelo\" para criar um.",
    useTemplateFailed: "Não foi possível criar um projeto a partir deste modelo",
    useTemplateAgentLabel: "Usar o modelo \"{{title}}\"",
    templateBriefTitle: "Usar \"{{title}}\" com um briefing",
    templateBriefPlaceholder: "Sobre o que é o novo projeto? Público, produto, mensagem principal…",
    templateBriefSubmit: "Criar e adaptar",
