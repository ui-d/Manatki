...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "Als Vorlage gespeichert",
    saveAsTemplateFailed: "Konnte nicht als Vorlage gespeichert werden",
  ...
  brandCheck: {
    title: "Marken-Check",
    checkedAgainst: "Geprüft gegen {{title}}",
    clean: "Markenkonform — keine Probleme gefunden.",
    fixWithAi: "Mit KI beheben",
    fixMessage: "{{total}} Marken-Probleme aus dem Marken-Check beheben",
    recheck: "Erneut prüfen",
    failed: "Marken-Check fehlgeschlagen",
    slide: "Folie {{slide}}",
    goToSlide: "Zur Folie",
  },
  share: {
  ...
  home: {
    ...
    socialBadge: "Social",
    filterTemplates: "Vorlagen",
    templateBadge: "Vorlage",
    useTemplate: "Vorlage verwenden",
    useTemplateWithBrief: "Mit Briefing verwenden…",
    templateEmptyState: "Noch keine Vorlagen. Öffne ein Projekt und wähle „Als Vorlage speichern“, um eine zu erstellen.",
    useTemplateFailed: "Aus dieser Vorlage konnte kein Projekt erstellt werden",
    useTemplateAgentLabel: "Vorlage „{{title}}“ verwenden",
    templateBriefTitle: "„{{title}}“ mit Briefing verwenden",
    templateBriefPlaceholder: "Worum geht es im neuen Projekt? Zielgruppe, Produkt, Kernbotschaft…",
    templateBriefSubmit: "Erstellen & anpassen",
