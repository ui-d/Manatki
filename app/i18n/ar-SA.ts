...
const messages = {
  ...
  editorToolbar: {
    ...
    savedAsTemplateToast: "تم الحفظ كقالب",
  ...
  home: {
    ...
    filterTemplates: "القوالب",
    templateBadge: "قالب",
    useTemplate: "استخدام القالب",
    useTemplateWithBrief: "استخدام مع ملخص…",
    templateEmptyState: "لا توجد قوالب بعد. افتح مشروعًا واختر «حفظ كقالب» لإنشاء واحد.",
    useTemplateFailed: "تعذر إنشاء مشروع من هذا القالب",
    useTemplateAgentLabel: "استخدام القالب «{{title}}»",
    templateBriefTitle: "استخدام «{{title}}» مع ملخص",
    templateBriefPlaceholder: "ما موضوع المشروع الجديد؟ الجمهور، المنتج، الرسالة الأساسية…",
    templateBriefSubmit: "إنشاء وإعادة صياغة",
